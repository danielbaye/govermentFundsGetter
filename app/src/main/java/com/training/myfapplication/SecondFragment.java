...
public class SecondFragment extends Fragment {
    ...
    private void setupPieChart(ArrayList<Map.Entry<String, Float>> departmentsAndValues) {
        ...
        // recyclerView.findViewHolderForAdapterPosition((int)h.getX());
        // if (viewHolder != null) {
        ...
        for (int i = departmentsAndValues.size() - 1; i >= 0; i--) {
            if (i > departmentsAndValues.size() - 11)
                // entries.add(new
                // PieEntry(departmentsAndValues.get(i).getValue(),departmentsAndValues.get(i).getKey()));
    ...
    public void loadData(String name) {
        ...
        ArrayList<Map.Entry<String, Float>> currentYearValues = getCurrentYearValues(String.valueOf(currentYear));
